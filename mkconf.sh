...
echo ${yel}==================================${end}
echo 
echo This script will create a configuration file for your eggdrop bot.
echo 
echo ${yel}To get started, please tell me the nickname of the your bot. 
echo ${red}This is critical, as this script will rely on this for 
...
clear
read -p "${blu}Would you like to create a configuration file for $botname? (y/n)?${end} " CONF
if [ "$CONF" = "y" ]; then
  clear
  ...
  echo >&3
  echo >&3
  echo "#If you don't know how to configure this file, refer to the eggdrop.conf file located in /home/$USER/eggdrop to see the help comments." >&3
  ...
  echo
  echo
  echo "Please type your server's IPv4 address. Your bot will bind to this address. This address should be publicly"
  ...
  if [ "$ircs" = "y" ]; then
	...
	echo "${mag}Example (For a direct connection):${end} irc.undernet.org:6667"
  ...
  if [ "$sinstall" = "y" ]; then
	...
	echo "#Scripts" >&3
	echo "#Use this section to load scripts into your bot." >&3
    echo "#To load a script, copy the file into your scripts folder,"
    echo "#then source it as shown below. Be sure to use the file name."
    echo 
    echo "#source scripts/script_name.tcl"
  fi
  clear
  exec 3>&- 
  echo -e "${grn}
  ...
  ╚═╝     ╚═╝╚═╝  ╚═══╝╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚═════╝  
  "
  echo "${grn}Now you should have a configuration file for your bot. However, you'll still need to create your userfile. To do this, run ${yel}./eggdrop -m $botname${grn} after copying your eggdrop conf file from the newly created directory in your home folder. ${end}"
  echo 
else
  clear
  echo -e "${red}
